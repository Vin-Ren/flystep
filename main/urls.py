...
from main.views import render_all_json, render_all_xml, render_by_id_json, render_by_id_xml, render_create_product, render_login, render_logout, render_main, render_product_details, render_register
